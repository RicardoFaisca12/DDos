...
def main():
	...
	while True:
		...
		sin = input("\033[1;00m[\033[97mKatchau\033[1;00m]-\033[91m⚡️ \033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
			...
			try:
				...
				print ("[\033[97mKatchau\033[00m] Starting Ping On Host: {}".format (host))
				try:
					ip = socket.gethostbyname(host)
				except socket.gaierror:
					print ("[\033[97mKatchau\033[00m] Host Un-Resolvable.")
					main()
				while True:
					try:
						sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
						...
						print ("[\033[97mKatchau\033[00m] | Time: {}ms [UP]".format(ip, dport, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("")
						print ("[\033[97mKatchau\033[00m] {}:{} [DOWN]".format(ip, dport))
						time.sleep(1)
					except KeyboardInterrupt:
						print("")
						main()
			except ValueError:
				print ("[\033[97mKatchau\033[00m] The Command {} Requires An Argument.".format (sinput))
				main()
		elif sinput == "udp":
			if username == "Guest":
